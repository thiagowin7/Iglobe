(function() {
    function e(b, c) {
        this.selector = null;
        c ? this.nodes = c : "string" == typeof b ? (this.selector = b,
        this.nodes = document.querySelectorAll(b)) : this.nodes = [b];
    ...
    function k(b, c) {
        ...
        function k(a) {
            for (var c in G) {
                ...
                void 0 != g && ("true" === g ? g = !0 : "false" === g && (g = !1),
                a[c] = g))
            }
            f = a || {};
            for (c in G)
        ...
        function r() {
            ...
            X();
            d("#" + b + " .ism-radios input.ism-radio, #" + b + " .ism-radios .ism-radio-label").off("click", H);
            ...
            for (d("#" + b + " .ism-tmp-clone").remove(); 0 < d("#" + b + " .ism-frame").length; )
        ...
        function v() {
            ...
            "manual" != f.play_type && (clearTimeout(B),
            B = setTimeout(a, f.interval))
        }
        function a() {
            var a = p + 1;
            A && "manual" != f.play_type && ("once" == f.play_type && p == m() - 2 ? (y(a),
            g()) : "once-rewind" == f.play_type && p == m() - 1 ? (y(0),
            g()) : ("loop" == f.play_type && p == m() - 1 ? y(0) : y(a),
            v()))
        }
        function g() {
            A = !1;
        ...
        function T() {
            f.buttons && (n.after("<div class='ism-button ism-button-prev'>&nbsp;</div><div class='ism-button ism-button-next'>&nbsp;</div>"),
        ...
        function ca() {
            if (f.radios) {
                ...
                for (var a = 0; a < m(); a++)
                    0 == a ? z.append("<li class='ism-radio-" + a + " active'><input type='radio' name='ism-radio' class='ism-radio' id='ism-radio-" + a + "' checked='checked' /><label class='ism-radio-label' for='ism-radio-" + a + "'></label></li>") : z.append("<li class='ism-radio-" + a + "'><input type='radio' name='ism-radio' class='ism-radio' id='ism-radio-" + a + "' /><label class='ism-radio-label' for='ism-radio-" + a + "'></label></li>");
        ...
        function Z(a) {
            f.radios && (d("#" + b + " .ism-radios li").removeClass("active"),
        ...
        function y(a, b) {
            if (!0 !== F && a != p) {
                ...
                "instant" == f.transition_type ? (g = a,
                q.setStep(g + 1, 1, !0),
                L(c, g, !0, b)) : "slide" == f.transition_type ? ea(c, a, b) : "fade" == f.transition_type ? ba(c, a, !1, b) : "zoom" == f.transition_type && ba(c, a, !0, b)
            }
        }
        function ea(a, b, c) {
            var g = b / (m() - 1);
        ...
        function O(a) {
            W();
            "none" != f.image_fx && ("zoompan" == f.image_fx ? d("#" + b + " .ism-slide-" + a + " .ism-img-frame").addClass("ism-zoom-pan") : "zoomrotate" == f.image_fx && d("#" + b + " .ism-slide-" + a + " .ism-img-frame").addClass("ism-zoom-rotate"))
        }
        function W() {
        ...
        this.setRadioType = function(a) {
            "thumbnail" == a ? d("#" + b + " .ism-radios").addClass("ism-radios-as-thumbnails") : d("#" + b + " .ism-radios").removeClass("ism-radios-as-thumbnails")
        }
        ;
    ...
    e.prototype.index = function() {
        for (var b = this.el, c = 0; null != (b = b.previousSibling); )
            c++;
        return c
    }
    ;
    ...
    e.crossFade = function(b, c, d, e) {
        ...
        var r = +new Date, u, m = function() {
            ...
            r = +new Date;
            0 < h ? window.requestAnimationFrame && requestAnimationFrame(m) || setTimeout(m, 16) : (b.style.opacity = 0,
            c.style.opacity = 1,
            b.style.filter = "",
            c.style.filter = "",
            e && e())
...
(function(e, d) {
    ...
    d.prototype = {
        ...
        init: function() {
            if (this.options.css3) {
                var a = this.handle;
                r.backfaceVisibility && r.perspective && (a.style[r.perspective] = "1000px",
        ...
        onWrapperTouchMove: function(a) {
            h.refresh(a);
            !this.activity && this.draggingOnDisabledAxis() ? this.dragging && this.stopDrag() : (l(a),
            this.activity = !0)
        },
        onWrapperMouseDown: function(a) {
            a.target && 0 <= a.target.className.search(/ism-(button|radio|caption)/) || (h.refresh(a),
            l(a),
            this.startTap())
        },
        ...
        onDocumentMouseUp: function(a) {
            this.stopDrag();
            this.stopTap();
            a.target && 0 <= a.target.className.search(/ism-(button|radio|caption)/) || this.options.afterSwipeCallback()
        },
        ...
        onHandleClick: function(a) {
            a.target && 0 <= a.target.className.search(/ism-(button|radio)/) || !this.activity || (l(a),
            M(a))
        },
        ...
        setValue: function(a, b, c) {
            ...
            c && (this.groupCopy(this.value.current, this.value.target),
            this.updateOffsetFromValue(),
            this.callAnimationCallback())
        },
        startTap: function() {
            !this.disabled && this.options.tapping && (this.tapping = !0,
            this.setWrapperOffset(),
            this.setTargetValueByOffset([h.x - this.offset.wrapper[0] - this.handle.offsetWidth / 2, h.y - this.offset.wrapper[1] - this.handle.offsetHeight / 2]))
        },
        stopTap: function() {
        ...
        startDrag: function() {
            ...
            this.interval = this.requestAnimationFrame(this.animateWithRequestAnimationFrame),
            this.setWrapperOffset(),
            this.offset.mouse = [h.x - w.get(this.handle)[0], h.y - w.get(this.handle)[1]],
        ...
        callAnimationCallback: function() {
            ...
            this.groupCompare(a, this.value.prev) || ("function" == typeof this.options.animationCallback && this.options.animationCallback.call(this, a[0], a[1]),
        ...
        animateWithRequestAnimationFrame: function(a) {
            a ? (this.timeOffset = this.timeStamp ? a - this.timeStamp : 0,
            this.timeStamp = a) : this.timeOffset = 25;
        ...
        glide: function() {
            ...
            if (!a[0] && !a[1])
                return !1;
            Math.abs(a[0]) > this.valuePrecision[0] || Math.abs(a[1]) > this.valuePrecision[1] ? (this.value.current[0] += a[0] * Math.min(this.options.speed * this.timeOffset / 25, 1),
            this.value.current[1] += a[1] * Math.min(this.options.speed * this.timeOffset / 25, 1)) : this.groupCopy(this.value.current, this.value.target);
            return !0
        },
        animateSlide: function() {
            for (var a = this.value.target[0] - this.value.current[0], b = 0 <= a ? 1 : -1, a = Math.abs(a), c = (this.value.current[0] - this.slide_start) / (this.value.target[0] - this.slide_start), d = c - .5, d = (-3 * d * d + .8) * this.step_size * .08; d > a; )
                d *= .5;
            .995 < c ? (this.groupCopy(this.value.current, this.value.target),
            this.sliding = !1,
            this.slide_callback()) : this.value.current[0] += b * d;
            this.updateOffsetFromValue();
        ...
        renderHandlePosition: function() {
            var a = "";
            this.options.css3 && r.transform ? (this.options.horizontal && (a += "translateX(" + this.offset.current[0] + "px)"),
            this.handle.style[r.transform] = a) : this.options.horizontal && (this.handle.style.left = this.offset.current[0] + "px")
        },
        ...
        getClosestStep: function(a) {
            for (var b = 0, c = 1, d = 0; d <= this.options.steps - 1; d++)
                Math.abs(this.stepRatios[d] - a) < c && (c = Math.abs(this.stepRatios[d] - a),
                b = d);
    ...
    for (var k = function(a, b) {
        ...
        set: function(a) {
            ...
            if (a.clientX || a.clientY)
                ...
                this.x = a.pageX - document.body.scrollLeft - document.documentElement.scrollLeft,
                this.y = a.pageY - document.body.scrollTop - document.documentElement.scrollTop;
    ...
    }, u = ["webkit", "moz"], m = window.requestAnimationFrame, x = window.cancelAnimationFrame, v = 0; v < u.length && !m; ++v)
        m = window[u[v] + "RequestAnimationFrame"],
        x = window[u[v] + "CancelAnimationFrame"] || window[u[v] + "CancelRequestAnimationFrame"];
    m || (m = function(a) {
